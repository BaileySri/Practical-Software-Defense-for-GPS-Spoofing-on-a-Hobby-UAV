...
const AP_Param::GroupInfo AP_RangeFinder_Params::var_info[] = {
    ...
    // @Description: When performing a basic attack the drone will be offset by xxxxxxx_RAT cm every update
    // @Units: cm
    // @Range: FLOAT_MIN FLOAT_MAX
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("xxxxxxx_RAT", 54, AP_RangeFinder_Params, rate, 0),
    // @Param: xxxxxxx_RAT
